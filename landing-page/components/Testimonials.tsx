...
export default function Testimonials({ testimonials }: { testimonials: Testimonial[] }) {
  return (
    <div className='mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8'>
      <div className='relative sm:left-5 -m-2 rounded-xl bg-purple-600/20 lg:ring-1 lg:ring-purple-500/40 lg:-m-4 '>
      {/*  bg-yellow-400/20 lg:ring-1 lg:ring-yellow-500/50 */}
